...
The same assembly-line contract now also governs issue #836 dense-linear work.
Its executable inventory and evidence live in
`DirectPtxDenseLinearCoverageManifest` and
