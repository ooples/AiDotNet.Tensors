...
public partial class DirectGpuTensorEngine : CpuEngine, ITensorLevelEngine, IDisposable
{
    ...
    Tensor<T> IEngine.TensorBroadcastAdd<T>(Tensor<T> a, Tensor<T> b2)
    {
        if (typeof(T) == typeof(float) && TryGetBackend(out var b))
        {
            try
            {
                int aLen = a.Length, bLen = b2.Length;
                if (aLen > bLen && aLen % bLen == 0)
                {
                    int outerSize = aLen / bLen;
                    ...
                    using var go = b.AllocateBuffer(aLen);
                    b.BroadcastAddLast(ga, gb, go, outerSize, bLen);
        ...
        if (typeof(T) == typeof(float) && TryGetBackend(out var b))
        {
            try
            {
                ...
                if (aLen > bLen && aLen % bLen == 0)
                {
                    ...
                    using var gb = b.AllocateBuffer(((Tensor<float>)(object)b2).GetDataArray());
                    using var go = b.AllocateBuffer(aLen);
                    b.BroadcastSubLast(ga, gb, go, outerSize, bLen);
                    return new Tensor<T>((T[])(object)b.DownloadBuffer(go), a.Shape.ToArray());
                }
            }
            catch { }
        ...
        if (typeof(T) == typeof(float) && TryGetBackend(out var b))
        {
            try
            {
                ...
                if (aLen > bLen && aLen % bLen == 0)
                {
                    ...
                    using var gb = b.AllocateBuffer(((Tensor<float>)(object)b2).GetDataArray());
                    using var go = b.AllocateBuffer(aLen);
                    b.BroadcastMulLast(ga, gb, go, outerSize, bLen);
                    return new Tensor<T>((T[])(object)b.DownloadBuffer(go), a.Shape.ToArray());
                }
            }
            catch { }
        ...
        if (typeof(T) == typeof(float) && TryGetBackend(out var b))
        {
            try
            {
                ...
                if (aLen > bLen && aLen % bLen == 0)
                {
                    ...
                    using var gb = b.AllocateBuffer(((Tensor<float>)(object)b2).GetDataArray());
                    using var go = b.AllocateBuffer(aLen);
                    b.BroadcastDivLast(ga, gb, go, outerSize, bLen);
                    return new Tensor<T>((T[])(object)b.DownloadBuffer(go), a.Shape.ToArray());
                }
            }
            catch { }
