...
/// </para>
/// </remarks>
public sealed partial class WebGpuBackend : IDirectGpuBackend, IDisposable, IFusedAdvancedKernels, ICompressedMomentGpuOptimizerBackend, IPixelShuffleBackend, INativeGpuCodegenExecutor
{
    /// <summary>
