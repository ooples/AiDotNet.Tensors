...
public sealed partial class MetalBackend
{
    ...
    public void ReflectPad1d(IGpuBuffer input, IGpuBuffer output, int batch, int l, int lp, int pad) => throw new NotSupportedException("ReflectPad1d not yet implemented on the Metal backend.");
    public void StftMagPhase(IGpuBuffer padded, IGpuBuffer window, IGpuBuffer mag, IGpuBuffer phase, int batch, int lp, int nFft, int hop, int numFrames, int numFreqs) => throw new NotSupportedException("StftMagPhase not yet implemented on the Metal backend.");
    public void PhaseVocoder(IGpuBuffer mag, IGpuBuffer phase, IGpuBuffer newMag, IGpuBuffer newPhase, int leading, int nFramesV, int nFreqV, int outFrames, float rate) => throw new NotSupportedException("PhaseVocoder not yet implemented on the Metal backend.");
    public void BuildSpectrum(IGpuBuffer mag, IGpuBuffer phase, IGpuBuffer specRe, IGpuBuffer specIm, int batch, int numFreqs, int numFrames, int nFft) => throw new NotSupportedException("BuildSpectrum not yet implemented on the Metal backend.");
    public void IstftFromSpectrum(IGpuBuffer specRe, IGpuBuffer specIm, IGpuBuffer window, IGpuBuffer result, IGpuBuffer windowSum, int batch, int numFrames, int nFft, int hop, int outputLength, int center) => throw new NotSupportedException("IstftFromSpectrum not yet implemented on the Metal backend.");
    public void IstftNormalize(IGpuBuffer result, IGpuBuffer windowSum, int total) => throw new NotSupportedException("IstftNormalize not yet implemented on the Metal backend.");
    ...
    public void PairwiseIou(IGpuBuffer boxes, IGpuBuffer iou, int n) => throw new NotSupportedException("PairwiseIou not yet implemented on the Metal backend.");
    ...
    public void GridSampleBackwardGridNhwc(IGpuBuffer gradOut, IGpuBuffer input, IGpuBuffer grid, IGpuBuffer gradGrid, int batch, int h, int w, int c, int outH, int outW) => throw new NotSupportedException("GridSampleBackwardGridNhwc not yet implemented on the Metal backend.");
