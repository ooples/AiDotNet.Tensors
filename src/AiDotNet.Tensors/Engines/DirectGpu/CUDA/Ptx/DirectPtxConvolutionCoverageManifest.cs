...
internal static class DirectPtxConvolutionCoverageManifest
{
    ...
    [
        ...
        Planned("DirectGpuTensorEngine.Conv2DBackwardBiasGpu", "CUDA reduction", "2D bias gradient", "NCHW to vector", "FP32", "fuse with backward-weight where beneficial"),
        ...
        Planned("IEngine.DepthwiseConv2D", "CUDA NVRTC depthwise kernel", "depthwise 2D forward", "NCHW/depthwise OIHW", "generic/FP32", "direct/tiled bias-activation families"),
        Planned("IEngine.DepthwiseConv2DBackwardInput", "CUDA depthwise backward-input", "depthwise 2D input gradient", "NCHW", "generic/FP32", "deterministic backward-input PTX"),
        Planned("IEngine.DepthwiseConv2DBackwardKernel", "CUDA depthwise backward-weight", "depthwise 2D weight gradient", "OIHW", "generic/FP32", "deterministic backward-weight PTX"),
