...
internal static class DirectPtxConvolutionCoverageManifest
{
    ...
    [
        ...
        new("IEngine.Conv2DBackwardInput",
            ...
            DirectPtxConvolutionCoverageStatus.ExperimentalDirectPtx,
            "v1 exact N1/C64/H16/W16/K64 1x1 FP32 (transposed-weight mat-vec); all else falls back"),
        ...
        new("IEngine.Conv2DBackwardKernel",
            ...
            DirectPtxConvolutionCoverageStatus.ExperimentalDirectPtx,
            "v1 exact N1/C64/H16/W16/K64 1x1 FP32 thread-per-weight full-dot (deterministic); all else falls back"),
