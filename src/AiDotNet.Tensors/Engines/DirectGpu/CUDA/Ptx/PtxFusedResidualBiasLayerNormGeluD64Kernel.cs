...
internal sealed class PtxFusedResidualBiasLayerNormGeluD64Kernel : IDisposable
{
    ...
    // Historical screening is promising, but promotion requires current-head
    // three-run and executed-SASS spill evidence for the complete issue scope.
    internal static bool IsPromotedRows(int rows) => false;
