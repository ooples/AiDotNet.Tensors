...
internal static class DirectPtxSpectralCoverageManifest
{
    ...
    [
        ...
        Planned("CudaBackend.SplitComplexConjugate", "NVRTC split_complex_conjugate", "split complex conjugate", Split, "FP32", "split-conjugate-cells"),
        Planned("CudaBackend.SplitComplexMagnitude", "NVRTC split_complex_magnitude", "split magnitude", Split, "FP32", "split-magnitude-cells"),
        Planned("CudaBackend.SplitComplexMagnitudeSquared", "NVRTC split_complex_magnitude_squared", "split power", Split, "FP32", "split-power-cells"),
        Planned("CudaBackend.SplitComplexPhase", "NVRTC split_complex_phase", "split phase", Split, "FP32", "split-phase-cells"),
        ...
        Planned("CudaBackend.SplitComplexAdd", "NVRTC split_complex_add", "complex add", Split, "FP32", "split-add-cells"),
        ...
        Planned("CudaBackend.RFFT", "NVRTC complex FFT plus extraction", "real-to-positive-frequency FFT", Split, "FP32", "fused-real-pack-rfft-cells"),
        Planned("CudaBackend.IRFFT", "NVRTC reconstruction plus IFFT", "positive-frequency-to-real IFFT", Split, "FP32", "fused-irfft-unpack-cells"),
