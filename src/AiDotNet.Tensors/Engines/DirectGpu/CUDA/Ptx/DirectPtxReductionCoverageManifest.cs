...
internal static class DirectPtxReductionCoverageManifest
{
    ...
    [
        ...
        Planned("CudaBackend.MeanAxis", "NVRTC mean_axis", "arithmetic mean over last axis", Rows, "FP32", "warp-row-mean-exact-shape-families"),
        Planned("CudaBackend.MaxAxis", "NVRTC max_axis", "maximum over last axis", Rows, "FP32", "warp-row-max-exact-shape-families"),
        Planned("CudaBackend.MinAxis", "NVRTC min_axis", "minimum over last axis", Rows, "FP32", "warp-row-min-exact-shape-families"),
