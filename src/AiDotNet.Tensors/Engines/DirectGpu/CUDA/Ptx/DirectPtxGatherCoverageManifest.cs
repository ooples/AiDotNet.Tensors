...
internal static class DirectPtxGatherCoverageManifest
{
    ...
    [
        ...
        Planned("CudaBackend.ScatterAddRows", "NVRTC scatter-add in CudaBackend.InstantNgp", "output[index[i],:] += source[i,:]", Indexed, "FP32 rows; INT32 indices", "atomic-scatter-add-row-families"),
