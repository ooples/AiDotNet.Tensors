...
internal static class DirectPtxPoolingCoverageManifest
{
    ...
    [
        ...
        Planned("CudaBackend.GlobalMaxPool2D", "NVRTC global_maxpool2d", "max over H*W per channel", Bchw, "FP32", "warp-row-global-max-families"),
        ...
        Planned("CudaBackend.UpsampleNearest2D", "NVRTC upsample_nearest2d", "nearest-neighbor spatial upsample", Windowed, "FP32", "baked-scale-nearest-families"),
        Planned("CudaBackend.UpsampleBilinear2D", "NVRTC upsample_bilinear2d", "bilinear spatial upsample", Windowed, "FP32", "baked-scale-bilinear-families"),
        Planned("CudaBackend.Interpolate", "NVRTC interpolate", "generic spatial interpolation", Windowed, "FP32", "baked-mode-scale-families"),
        ...
        Planned("CudaBackend.GridSample2D", "NVRTC grid_sample2d", "bilinear sampling at normalized grid coords", "canonical contiguous NCHW input + [N,Ho,Wo,2] grid", "FP32", "bilinear-grid-sample-families"),
        Planned("CudaBackend.RoiAlign", "NVRTC roi_align", "region-of-interest aligned pooling", "canonical contiguous NCHW + [K,5] rois", "FP32", "baked-output-bins-roi-families"),
        Planned("CudaBackend.SpatialTransform", "NVRTC spatial_transform", "affine-grid spatial warp", "canonical contiguous NCHW + [N,2,3] theta", "FP32", "affine-grid-sample-families"),
