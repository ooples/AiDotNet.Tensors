...
internal static class DirectPtxNormalizationCoverageManifest
{
    ...
    [
        ...
        Direct("CudaBackend.LayerNormBackward", "NVRTC layernorm_backward + layernorm_grad_params", "gradInput plus deterministic affine gradients", RowMajor, "FP32", "Ampere D64 rows 256/2048/8192; single-pass fused atomic experiment at 8192"),
        ...
        Direct("CudaBackend.RmsNormBackward", "NVRTC rmsnorm_backward + rmsnorm_grad_gamma", "gradInput plus deterministic gamma gradient", RowMajor, "FP32", "Ampere D64 rows 256/2048/8192; single-pass fused atomic experiment at 8192"),
        ...
        Direct("CudaBackend.ReduceNormL2", "NVRTC atomic/deterministic scalar reduction", "deterministic whole-buffer sum of squares", "contiguous vector", "FP32", "Ampere sizes 16384/131072/524288; 512-thread atomic experiment remains unselected"),
