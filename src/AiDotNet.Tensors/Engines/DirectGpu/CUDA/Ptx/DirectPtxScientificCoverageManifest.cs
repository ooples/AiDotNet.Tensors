...
internal static class DirectPtxScientificCoverageManifest
{
    ...
    [
        ...
        new("CudaBackend.ComplexConjugate", "NVRTC complex conjugate", "(ar, -ai)", InterleavedComplex, "FP32", DirectPtxScientificCoverageStatus.PlannedDirectPtx, Planned),
        new("CudaBackend.ComplexMagnitude", "NVRTC complex magnitude", "sqrt(re^2+im^2)", SplitComplex, "FP32", DirectPtxScientificCoverageStatus.PlannedDirectPtx, Planned),
