...
internal static class DirectPtxQuantizedMixedSparseCoverageManifest
{
    ...
    [
        ...
        Direct("CudaBackend.FusedLinearGELUFp16TransposedM16", "direct PTX async MMA or cublasGemmEx+bias+GELU", "gelu_tanh(fp32(X@transpose(W))+bias)", "X[16,K], W[N,K], bias[N], output[16,N]", "FP16/FP16/FP32->FP32", "v3 Ampere M=16 bank-conflict-free cp.async+mma K/N=512/2048 and 1024/4096 promoted"),
