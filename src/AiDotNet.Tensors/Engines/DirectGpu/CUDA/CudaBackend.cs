...
";
    ...
    {
#if NET5_0_OR_GREATER
        if (TryDirectPtxCapsuleProjection(
            input, weights, output, batchSize, inputCapsules, inputDim, outputCapsules, outputDim,
            DirectPtxCapsuleProjectionOperation.Predictions))
            return;
#endif
...
#if NET5_0_OR_GREATER
        if (TryDirectPtxCapsuleProjection(
            input, weights, output, batchSize, inputCapsules, inputDim, numCapsules, capsuleDim,
            DirectPtxCapsuleProjectionOperation.Transform))
            return;
#endif
    ...
    {
#if NET5_0_OR_GREATER
        if (TryDirectPtxCapsuleRouting(
            coupling, predictions, output, batchSize, inputCapsules, outputCapsules, capsuleDim,
            DirectPtxCapsuleRoutingOperation.WeightedSum))
            return;
#endif
...
#if NET5_0_OR_GREATER
        if (TryDirectPtxCapsuleRouting(
            predictions, output, agreement, batchSize, inputCapsules, outputCapsules, capsuleDim,
            DirectPtxCapsuleRoutingOperation.Agreement))
            return;
#endif
