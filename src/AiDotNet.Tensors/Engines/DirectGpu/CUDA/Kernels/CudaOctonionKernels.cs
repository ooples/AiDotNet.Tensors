...
// CUDA kernels for octonion neural network operations.
// Implements 8-component non-associative algebra with full forward and backward support.

namespace AiDotNet.Tensors.Engines.DirectGpu.CUDA.Kernels;

/// <summary>
/// CUDA kernels for octonion algebra operations used in octonion neural networks.
/// Implements the Cayley-Dickson construction for octonion multiplication.
/// </summary>
internal static class CudaOctonionKernels
{
