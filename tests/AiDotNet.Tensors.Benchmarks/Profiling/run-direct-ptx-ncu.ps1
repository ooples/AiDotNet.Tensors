param(
    [ValidateSet('attention', 'residual-rmsnorm', 'decode', 'paged-prefill', 'attention-backward', 'flash-attention-backward', 'qkv-rope-cache', 'solvers-4x4', 'rng-dropout', 'rng-stochastic', 'convolution', 'vision-box-iou', 'rglru', 'global-avgpool', 'complex-multiply')]
