param(
    [ValidateSet('attention', 'residual-rmsnorm', 'decode', 'paged-prefill', 'attention-backward', 'flash-attention-backward', 'qkv-rope-cache', 'rng-dropout', 'rng-stochastic', 'convolution', 'vision-box-iou', 'rglru', 'normalization', 'residual-layernorm-gelu', 'fused-linear', 'mixed-linear', 'mixed-linear-m16', 'w8a8-linear')]
