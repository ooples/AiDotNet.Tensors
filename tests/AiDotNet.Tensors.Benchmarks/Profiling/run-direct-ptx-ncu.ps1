param(
    [ValidateSet('attention', 'residual-rmsnorm', 'decode', 'paged-prefill', 'attention-backward', 'flash-attention-backward', 'qkv-rope-cache', 'csr-spmm')]
...
$switch = switch ($Target) {
    ...
    'csr-spmm' { '--direct-ptx-profile-csr-spmm' }
}
$kernel = switch ($Target) {
    ...
    'csr-spmm' { 'regex:aidotnet_csr_spmm_vec4_f32' }
}
