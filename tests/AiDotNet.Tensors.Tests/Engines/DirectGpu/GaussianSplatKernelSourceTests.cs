...
public sealed class GaussianSplatKernelSourceTests
{
    ...
    [InlineData(WebGpuExt, "GaussianCovariance", "let r00=1.0-2.0*(qy*qy+qz*qz);", "let r12=2.0*(qy*qz-qw*qx);")]
    ...
    [InlineData(WebGpuExt, "SphericalHarmonics", "basis[0]=0.282095;", "basis[6]=0.315392*(3.0*dz*dz-1.0);")]
